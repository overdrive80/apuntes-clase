...
\begin{homeworkProblem}[Conectate a B por medio de escritorio remoto, desde tu PC físico]
  \begin{itemize}
...
\begin{homeworkProblem}[Conectate a B por medio de escritorio remoto, desde el equipo B de otro compañero]
