...
\item Todos los empleados acceden a internet a través del mismo router (puedes representar internet por un servidor con la ip \texttt{8.8.8.8}). No es necesario que se haga NAT.
...
\item \textbf{No se valorará} el ejercicio si algún router tiene más de dos interfaces.
\end{itemize}
