...
- Ejercicio comparativo: La tierra tiene un radio de 6370 Km aproximadamente
  ¿Cuántas direcciones IPv4 hay por m2?
  ¿Cuántas direcciones IPv6 hay por m2?

** Direcciones IPv6
- Se especifican en hexadecimal, separando grupos de 32 bits con “:”
...
| ~fe80::interfaz/10~        | /[[https://es.wikipedia.org/wiki/Direcci%C3%B3n_de_Enlace-Local][link-local]]/. Equivalentes a APIPA (~169.254.0.0/16~ en IPv4). El identificador de interfaz es el EUI-64 bits |
...
| ~fc00::/7~                 | /[[https://en.wikipedia.org/wiki/Unique_local_address][Unique-local]]/. Parecidas a las redes privadas IPv6                                                           |
| ~ff00::/18~                | Grupos [[https://en.wikipedia.org/wiki/Multicast_address#IPv6][multicast]].                                                                                             |
...
- *[[https://tools.ietf.org/html/rfc4291#section-2.6][Anycast]]*
  ...
  - En IPv6, se calcula como la dirección de red en IPv4
...
** IOS
- Se puede utilizar el sufico eui64, o indicar completamente la dirección
  #+begin_src sh
...
** Windows
- Configura una máquina virtual Windows 7 en modo bridged con ip6
