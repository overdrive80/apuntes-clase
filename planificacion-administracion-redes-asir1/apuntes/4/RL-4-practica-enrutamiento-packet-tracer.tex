...
\begin{itemize}
\item Departamento de administración: 12 ordenadores. % /28
\item Departamento de contabilidad: 30 ordenadores. % /26
\item Departamento de ventas: 13 ordenadores.     % /28
\item Departamento de informática: 20 ordenadores.%  /27
\end{itemize}
...
\item Las redes libres deben ser lo más grandes y compactas posible.
\end{itemize}
...
\item No se usa \texttt{\enlace{https://es.wikipedia.org/wiki/Routing\_Information\_Protocol}{RIP}} ni \texttt{\enlace{https://es.wikipedia.org/wiki/Proxy\_ARP}{ARP Proxy}}
...
\item Hay etiquetas de texto explicando las redes asignadas y libres.
...
\item Los routers solo tienen dos interfaces (o solo se usan dos de sus interfaces)
\end{itemize}
