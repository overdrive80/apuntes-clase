...
\section{Enunciado}
Una empresa decide conectar varios departamentos en una sola red IP. Para ello, dispone de la red \texttt{192.168.\textit{2*N}.0/23} (\texttt{\textit{N}} indica el número de ordenador de clase del alumno usado en prácticas anteriores)
\begin{itemize}
