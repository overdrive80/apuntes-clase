...
** Código [[https://es.wikipedia.org/wiki/C%25C3%25B3digos_NRZ][NRZ-L]] (bipolar)
| 0 | -xV |
| 1 | +xV |
...
** Código [[https://es.wikipedia.org/wiki/C%C3%B3digos_NRZ][NRZI]] (bipolar)
| 0 | La señal no cambia       |
| 1 | La señal cambia de signo |
|---+--------------------------|
|   | Por lo demás, como NRZL  |
#+attr_latex: :width 0.6\textwidth
