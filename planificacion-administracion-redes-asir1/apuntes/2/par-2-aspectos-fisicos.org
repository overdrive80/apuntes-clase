...
- Consideramos canal digital a uno diseñado originalmente para llevar información digital
  - Siempre se puede cuantizar un canal analógico para convertir en digital
...
- Para el resto de la explicación se supondrán señales en banda base
  -  Aunque nada impide que esto se aplicase a banda ancha
...
[[file:media/multiplexacion-frecuencia.png]]
...
[[file:media/transmision-sincrona.png]]
