...
- Deformación de la señal por el hecho de que la velocidad de propagación de la señal en el medio varía con las características de la señal misma (ejemplo frecuencia).

** Interferencia
- Suma a la señal que se transmite de otra señal de origen conocido.
-  Ejemplo: cuando la señal de potencia, se acopla a la señal de datos transmitidos.
...
** Ruido
- Es la suma de múltiples interferencias, posiblemente de origen desconocido y de naturaleza aleatoria.  Los propios componentes físicos de cualquier canal o dispositivo de transmisión generan ruido eléctrico.  El ruido se puede aislar solo en ciertos casos.
