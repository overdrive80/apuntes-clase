...
La última versión de este documento está accesible en \enlace{https://alvarogonzalezsotillo.github.io/apuntes-clase/planificacion-administracion-redes-asir1/apuntes/2/par-2-practica-cableado-aula.pdf}{https://alvarogonzalezsotillo.github.io/apuntes-clase/planificacion-administracion-redes-asir1/apuntes/2/par-2-practica-cableado-aula.pdf}

\section{Enunciado}
Un posible cliente pide un presupuesto para realizar la instalación de una LAN en un aula de informática.
El aula tiene como dimensiones 20$\times$10 metros. Se pretenden instalar 21 ordenadores: 20 para alumnos y 1 para el profesor. El acceso a la red del edificio se realizará a través de un punto e red preexistente (ver plano) Además, se desea que el profesor disponga de un proyector.
