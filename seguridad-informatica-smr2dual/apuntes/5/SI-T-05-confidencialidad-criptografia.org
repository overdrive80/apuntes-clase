...
#+OPTIONS:   toc:2
# https://docs.google.com/document/d/1g0qPjo7TZaK3pjH0BGqPJCboH5ymPTlUI5UTK72qwmU/edit#
...
Como ejemplo histórico veremos el Cifrado del César.
...
- Con iguales características que AES, también se utilizan frecuentemente los otros finalistas de la convocatoria (Todos ellos publicados entre el año 2000 y el 2002, y de excelente funcionalidad)
  ...
  - Otros: En los últimos años, y de manera independiente al concurso han surgido algunos algoritmos. Ej: [[https://en.wikipedia.org/wiki/Camellia_(cipher)][Camellia]], de 2000 [[https://en.wikipedia.org/wiki/Salsa20][Salsa20, Chacha20 y Rumba20]] de 2008, 
...
- Se utilizan dos claves para cada persona o entidad que participe en la comunicación cifrada. Cada persona o entidad  que quiera *recibir* información cifrada debe tener éstas dos claves:
  - Una clave pública asociada a su identidad, y que cualquiera puede conocer. La clave pública se utiliza para que *los demás* cifren información dirigida a *ella*.
  - Una clave privada que debe mantener en secreto, y que servirá para descifrar los mensajes que los *demás le dirigen*.
...
Algoritmos asimétricos comunmente usados:
- RSA (Rivest-Shamir-Adleman) 1977. El más utilizado. Respaldado por una empresa: [[http://www.rsa.com/][RSA Security]], que mantiene su patente
...
- ECC 1985. Criptografía de curvas elípticas. Sujeto a patentes. Es un derivado de la criptografía asimétrica que utiliza claves más cortas y algoritmos más rápidos. Hay diversas variantes, que cuyo nombre comienza por EC. Ej: ECDH (Diffie Hellman)
...
La aplicación *Adobe Acrobat* permite utilizar un certificado X509 (DNIe, FNMT) para firmar digitalmente un PDF. La firma digital se guarda en el propio PDF y visualmente se ve un cuadro con los datos de la firma. Aunque un PDF firmado se puede imprimir, sólo se puede comprobar la firma teniendo el fichero
...
** Software firmado
Los ejecutables aplicaciones de Windows (y en otros sistemas operativos, por ejemplo, Android) llevan una firma digital, que los sistemas pueden comprobar durante la instalación. También se utiliza para evitar la copia en algunas videoconsolas.

[[file:media/firma-de-programa-windows.png]]
