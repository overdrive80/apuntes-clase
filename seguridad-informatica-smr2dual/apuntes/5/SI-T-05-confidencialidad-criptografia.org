...
Por ejemplo: 396307523=563 x 839. Si sólo te doy el primer número y te digo que está compuesto por dos primos...
...
- Las dos características anteriores hacen que en muchas ocasiones sean utilizados para transportar claves secretas de un algoritmo simétrico... y una vez transportada se utiliza un algoritmo simétrico, que es mucho más económico, rápido, y que su principal debilidad es el transporte de la clave secreta. Un ejemplo de esto es el [[#https][protocolo https]].
...
mecánica de utilización del DNIe y el certificado de la FNMT. https://www.incibe.es/extfrontinteco/dnie/swf/dnie.html
