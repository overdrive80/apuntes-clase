...
\begin{longtable}{lll}
\includegraphics[width=0.6\textwidth]{media/tarjeta-banda-magnetica.png} & \includegraphics[width=0.6\textwidth]{media/tarjeta-chip-inteligente.png} & \includegraphics[width=0.6\textwidth]{media/llave-magnetica.png}\\
\end{longtable}
...
\begin{longtable}{ll}
\includegraphics[width=0.6\textwidth]{media/centralita-alarma.png} & \includegraphics[width=0.6\textwidth]{media/centralita-y-sensores-alarma.png}\\
\end{longtable}
...
\label{sec:org899ac41}

\subsection{La red eléctrica}
\label{sec:orga750290}
...
\begin{longtable}{l}
\hline
Conector → Da corriente → tiene agujeros → está en el cable de corriente → No lo toques (por eso tiene agujeros, para que no lo toques por accidente)\\
Entrada → Toma corriente → tiene pines → está en la fuente de alimentación → Si ves los pines, es porque no está el conector. No hay corriente.\\
\hline
\end{longtable}
...
\begin{itemize}
\item C5/C62: 2.5 amperes máximo con toma de tierra. (Apodado “Mickey Mouse” o “Hoja de trébol”)  Se utiliza en portátiles.
\end{itemize}
...
\endlastfoot
\hline
Schuko & Europlug & Hasta 2.5A & \includegraphics[width=0.6\textwidth]{media/adaptador-schuko-europlug.png}\\
Schuko & Schuko & Hasta 16A & \includegraphics[width=0.6\textwidth]{media/adaptador-schuko-schuko.png}\\
Schuko & Schuko y Europlug & Hasta 16A en el Schuko. Hasta 2.5A en los Europlug & \includegraphics[width=0.6\textwidth]{media/adaptador-schuko-schukoeuroplug.png}\\
Algo parecido al Europlug & Agujeros compatibles con Schuko. & No permitido & \includegraphics[width=0.6\textwidth]{media/adaptador-europlug-schuko.png}\\
\end{longtable}



\subsection{Cálculo aproximado del consumo eléctrico}
\label{sec:org3ff1657}
...
\begin{longtable}{ll}
\includegraphics[width=0.6\textwidth]{media/sai-fontal.png} & \includegraphics[width=0.6\textwidth]{media/sai-trasera.png}\\
\end{longtable}
