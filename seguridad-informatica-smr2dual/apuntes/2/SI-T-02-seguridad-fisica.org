...
#+OPTIONS:   toc:2
#+STYLE: <style>.center {margin-left:auto; margin- right:auto;}</style>
...
- C5/C62: 2.5 amperes máximo con toma de tierra. (Apodado “Mickey Mouse” o “Hoja de trébol”)  Se utiliza en portátiles.
...
| Schuko                    | Schuko y Europlug                | Hasta 16A en el Schuko. Hasta 2.5A en los Europlug | [[file:media/adaptador-schuko-schukoeuroplug.png]] |
| Algo parecido al Europlug | Agujeros compatibles con Schuko. | No permitido                                       | [[file:media/adaptador-europlug-schuko.png]]       |
