...
* Introducción
En este tema hablaremos de las amenazas que se presentan al hardware de una manera directa, es decir, desde un punto de vista absolutamente físico, y de las medidas de seguridad más comunes ante cada una de ellas.
...
- Gases eliminadores del oxígeno. Tradicionalmente se han utilizado derivados del gas halón, pero dañan la capa de ozono. Existen soluciones alternativas, como el gas [[https://es.wikipedia.org/wiki/INERGEN][inergén]]  (nitrógeno, CO2 y argón), o el [[http://www.seguridadproteccioncontraincendios.es/fm-200-agente-extintor-fm-200-uso-y-aplicaciones/][FM200]] (heptafluorpropano)
...
- Componentes redundantes (N+1). 
  - Una única línea alimenta a dos SAI. Cada SAI es capaz de mantener a todos (N) los equipos.
...
- Componentes redundantes  2(N+1)
  - Duplicación de sistemas N+1. Implica que cada uno de los cuatro SAI puede mantener a todos los equipos. Hay dos líneas de alimentación exterior. Cada ordenador se conecta a los dos SAI de forma separada.
...
https://www.ovh.es/servidores_dedicados/niveles-tier-3-4.xml
...
El suelo técnico es un suelo que se monta sobre una estructura metálica con baldosas que habitualmente van sueltas, formando un segundo suelo más elevado sobre el suelo de obra. Tiene múltiples utilidades. No todas ellas están disponibles en todos los suelos técnicos.
  - Puede dar cobijo a la instalación eléctrica.
  - En salas de estaciones de trabajo también se suelen pasar otras instalaciones, como las de red para que los cables no estén visibles y puedan causar molestias o problemas. En salas de servidores la instalación de red no suele estar bajo el suelo porque no es demasiado práctico.
   - Si hay pequeños escapes de agua, puede albergar la humedad para que no llegue a los armarios
   - Si las baldosas del pasillo y las que quedan bajo los armarios se preparan eléctricamente pueden desviar la electricidad estática  y otras corrientes descontroladas para que no pase al personal (y no reciban calambres)
   - Puede contribuir en el circuito de refrigeración ambiental, inyectando aire frio en el suelo técnico, que se distribuirá bajo los racks porque el aire frío tiende a quedarse abajo. En los racks se pueden poner ventiladores en la parte superior que evacúan el aire caliente del  interior del rack, y el aire frío del suelo técnico ascenderá por el interior del rack.

#+caption:  Suelo técnico en Datacenter
[[file:media/suelo-tecnico-datacenter.png]]


#+caption: Suelo técnico en oficina
[[file:media/suelo-tecnico-oficina.png]]
...
- Tensión: 230 Volts (Con ±7% de oscilaciones permitidas, es decir, entre 213 y 247 Volts)
- Frecuencia: 50 Hertz
...
Los fabricantes de SAI nos dan una idea de su capacidad utilizando una unidad de medida poco conocida: el [[http://es.wikipedia.org/wiki/Voltio-amperio][Voltio-Amperio]] (VA). Esa unidad de medida tiene que ver con la [[http://es.wikipedia.org/wiki/Potencia_aparente][potencia aparente]] que es capaz de proporcionar el SAI.
Sin embargo, cuando compramos un ordenador (u otro equipo), los fabricantes nos acostumbran a hablarnos de su "consumo" en Watios... e incluso, en algunos casos, en Amperios. ¿Cómo saber si un SAI podrá dar corriente a un determinado equipo? aplica estas reglas:
...
#+caption SAI modular de [[https://www.salicru.com/slc-adapt.html][hasta 1.500 kVA]]
[[file:media/sai-modular-salicru.png]]
