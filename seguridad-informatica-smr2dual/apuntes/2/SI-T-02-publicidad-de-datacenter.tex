...
\newcommand{\enlacedirecto}[1]{\enlace{#1}{#1}}

Puedes buscar inspiración en algunas empresas que ya ofrecen este servicio
\begin{itemize}
\item \enlacedirecto{https://www.ovh.com/us/about-us/datacenters.xml}
\item \enlacedirecto{http://www.sapdatacenter.com/article/data\_center\_functionality/}
\item \enlacedirecto{https://www.soyoustart.com/es/cpd.xml}
\item \enlacedirecto{https://gigas.com/seguridad.html} y \enlacedirecto{https://gigas.com/tecnologia-cloud.html}
\item \enlacedirecto{https://journal.uptimeinstitute.com/switzerlands-first-tier-iv-certified-facility-achieves-energy-efficiency/}
\end{itemize}
