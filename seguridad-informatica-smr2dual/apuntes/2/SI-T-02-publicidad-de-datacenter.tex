...
Se enviará un documento (PDF,DOCX,ODT) a la tarea del \enlace{}{aula virtual}. Solo se admiten trabajos en pareja si no hay ordenadores suficientes disponibles en clase.
