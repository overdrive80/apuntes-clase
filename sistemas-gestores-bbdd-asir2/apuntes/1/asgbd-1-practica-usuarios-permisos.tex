...
\begin{homeworkProblem}[: Crear usuarios para tus compañeros]
  ...
  Tu propio usuario tendrá como \textit{tablespace} por defecto \texttt{USERS}, y los demás \texttt{PARAOTROS}. Los usuarios necesitan poder conectarse a la base de datos y crear tablas en su \textit{tablespace} por defecto. Los usuarios de los otros alumnos tendrán una cuota de 1MByte.
...
\begin{homeworkProblem}[: Creación de las tablas]
  ...
  \item Con tu propio usuario, crea las tablas en ese \textit{tablespace}
    \begin{itemize}
    \item Utiliza el \enlace{https://alvarogonzalezsotillo.github.io/sistemas-gestores-bbdd-asir2/apuntes/1/sql/carreras-coches.sql}{\textit{script} \texttt{carreras-coches.sql}} para la creación de las tablas
