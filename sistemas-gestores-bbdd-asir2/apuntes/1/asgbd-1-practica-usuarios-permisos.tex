...
\begin{homeworkProblem}[: \texttt{PROFESOR} con permisos especiales]
  Haz que el usuario \texttt{PROFESOR} tenga permisos de lectura en las vistas de sistema \texttt{DBA\_TABLES}, \texttt{DBA\_TABLESPACES} y \texttt{DBA\_DATA\_FILES}.
\end{homeworkProblem}
