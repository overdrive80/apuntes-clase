alter table comunidades drop constraint fk_cap;
alter table provincias drop constraint fk_com;
alter table localidades drop constraint fk_pro;
...
INSERT INTO COMUNIDADES VALUES(008,'CATALUÑA',343);
...
INSERT INTO PROVINCIAS VALUES(235,'A CORUÑA',286,100,012);
...
INSERT INTO LOCALIDADES VALUES(133,'SABIÑANIGO',8855,208);
INSERT INTO LOCALIDADES VALUES(134,'MONZON',15457,208);
--TERUEL
INSERT INTO LOCALIDADES VALUES(135,'TERUEL',32304,209);
INSERT INTO LOCALIDADES VALUES(136,'ALCAÑIZ',13708,209);
...
alter table comunidades add constraint fk_cap foreign key(cod_capital) references localidades;
alter table provincias add constraint fk_com foreign key(cod_comunidad) references comunidades;
alter table provincias add constraint fk_cap_pro foreign key(cod_capital) references localidades;
alter table localidades add constraint fk_pro foreign key(cod_provincia) references provincias;