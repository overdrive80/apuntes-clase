...
- Heredocs
  - [[https://unix.stackexchange.com/a/353689][Indentados]]: =<<-EOF=
...
- [[https://www.linuxjournal.com/content/bash-trap-command][/traps/]] para finalizar un /script/
- [[https://www.tutorialspoint.com/awk/awk_overview.htm][awk]], [[https://www.howtogeek.com/666395/how-to-use-the-sed-command-on-linux/][sed]], [[https://www.redhat.com/sysadmin/use-whiptail][whiptail]]

* Más avanzado: comandos desde PL/SQL
- http://www.dba-oracle.com/t_execute_operating_system_os_command_oracle.htm
- Se necesita el privilegio =CREATE EXTERNAL JOB=
- Solo he conseguido escribir ficheros en =$ORACLE_HOME=
#+begin_src sql
begin
