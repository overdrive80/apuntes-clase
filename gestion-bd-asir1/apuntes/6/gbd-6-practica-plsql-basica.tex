...
En clase hay accesible un servidor Oracle (\texttt{10.1.37.201}), con un usuario para cada alumno.
El profesor pasará unas pruebas automáticas, que dejarán el resultado en \enlace{http://10.1.37.201}{http://10.1.37.201}.
