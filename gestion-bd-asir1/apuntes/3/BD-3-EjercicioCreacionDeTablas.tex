...
\item Entrega tu trabajo en un fichero \texttt{ZIP}:
  ...
  \end{itemize}
\item Nota: los nombres de los ficheros incluyen un número (para que estén ordenados). No incluyas mayúsculas. No incluyas acentos. No pongas espacios. No añadas palabras, letras ni números a los nombres.
