...
\end{center}
  ...
  \item \texttt{V\_MENSAJESENVIADOSA(nombredestinatario, nombreemisor, textomensaje, recibido, leido)}: Todos los mensajes enviados a un destinatario, sean directos o dentro de un grupo de \texttt{chat}
...
\item Entrega tu trabajo en un fichero \texttt{ZIP}:
  ...
  \item Los ficheros de texto estarán codificados en UTF8. Es importante para las vocales acentuadas y símbolos especiales del español como \texttt{ñ}, \texttt{¿} \ldots
  \end{itemize}
