...
\item Hay una corrección automática accesible en \enlace{http://alvarogonzalez.no-ip.biz:8088/practica-privilegios}{http://alvarogonzalez.no-ip.biz:8088/practica-privilegios}.
\end{itemize}
