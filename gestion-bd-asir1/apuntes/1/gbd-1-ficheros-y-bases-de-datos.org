...
** Acceso vs organización
|                         | Acceso secuencial                    | Acceso directo                        |
| Organización secuencial | Fácil y rápido                       | Deben leerse los registros anteriores |
| Organización idexada    | Algo más lento (dos lecturas mínimo) | Más rápido (dos lecturas)             |
...
* Estándar ANSI/SPARC 
- Define tres niveles en un SGBD
