...
* Referencias
- Formatos:
  - [[file:gdb-1-ficheros-y-bases-de-datos.html][Transparencias]] 
  - [[file:gdb-1-ficheros-y-bases-de-datos.pdf][PDF]]
  - [[file:gdb-1-ficheros-y-bases-de-datos.org][Código fuente]]
