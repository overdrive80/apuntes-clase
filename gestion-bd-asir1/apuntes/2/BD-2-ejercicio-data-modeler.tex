...
\item El precio de un mueble puede depender de la terminación y las dimensiones, añadiendo sobreprecios independientes. Por ejemplo:
  ...
  % \item La misma mesa de y 80$\times$150 con pintura blanca cuesta 130\euro, pero lacada tiene un sobreprecio de 30\euro.
  % \end{itemize}
  \begin{itemize}
  \item Una mesa de 80$\times$120 con pintura blanca cuesta 100\euro, pero lacada tiene un sobreprecio de 20\euro.
  \item La misma mesa de y 80$\times$150 con pintura blanca cuesta 130\euro (por las nuevas dimensiones), pero el sobreprecio de la pintura lacada sigue siendo 20\euro.
  \end{itemize}
