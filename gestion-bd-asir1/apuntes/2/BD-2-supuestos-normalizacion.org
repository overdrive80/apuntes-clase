...
** Broker bursátil histórico
Para el ejercicio anterior, se necesita mantener un histórico de datos.
- Se supondrá que los inversores no cambian de broker
- La cantidad de acciones puede cambiar. Cada cambio tiene una fecha.
- Se apuntará la fecha en la que se reparte cada dividendo de acciones. La cantidad del dividendo puede ser distinta cada vez.
